...
public class fourMotors extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        int DOWN_POSITION = 30; //50
        int down_hold = 1800;
        
        double ratio_offset = 1.5;

        // 0 to 2940
        double LIFT_VEL = 1500; // og 600, max 1600 or else the motors will stall / twist. 300 for testing w/o weights
        ...
        for(int i = 0; i < 5; i++) {
            ...
            myMotor0.setPower(0.5);
            myMotor1.setPower(0.5);
            myMotor2.setPower(0.5);
            myMotor3.setPower(0.5);
